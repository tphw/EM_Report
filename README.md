...
## POCS 
  I've created two POCs to demonstrate the exploit. The first one POC is the case when Trunk's price is above 1.20 dollars , 1.59 to be precise , with more than 1 million losses, on July 21 , block number 40673000. The second POC is the case when Trunk's price is below 1.20 dollars, 0.88 cents, with approximately 300 K losses, on August 18, block number 41464000. 
